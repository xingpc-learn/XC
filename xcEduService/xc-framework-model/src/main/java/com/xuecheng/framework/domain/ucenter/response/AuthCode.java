...
public enum AuthCode implements ResultCode {
    ...
    AUTH_LOGIN_AUTHSERVER_NOTFOUND(false,23007,"登陆过程获取认证服务失败！"),
    AUTH_LOGIN_APPLYTOKEN_FAIL(false,23008,"登陆过程获取令牌失败！"),
    AUTH_LOGIN_TOKEN_SAVEFAIL(false,23009,"保存令牌到redis失败！"),
