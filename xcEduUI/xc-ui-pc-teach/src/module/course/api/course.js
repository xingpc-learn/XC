...
export const getCoursebaseById = courseId => {
  return http.requestQuickGet(apiUrl+'/course/coursebasebyid/'+courseId)
};
//修改更新课程基础信息
export const updateCoursebase = (courseId,coursebase)=>{
  return http.requestPut(apiUrl+'/course/updatecoursebase/'+courseId,coursebase)
};
...
export const updateCourseMarket = (courseId,coursemarket)=>{
  return http.requestPut(apiUrl+'/course/updatecoursemarket/'+courseId,coursemarket)
};
